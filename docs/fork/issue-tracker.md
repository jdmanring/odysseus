...
| [#123](https://github.com/jdmanring/odysseus/issues/123) | Persist catalog<->download association for discovered models (retire client base-name heuristic) | upstream-candidate | needs branch (from `upstream-mirror`). Root-cause for #121's client heuristic; relates to upstream #4049/#2342. |

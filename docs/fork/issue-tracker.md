...
| [#149](https://github.com/jdmanring/odysseus/issues/149) | HW-Fit fabricates Q4_K_M/llama.cpp identity for safetensors models with no GGUF | upstream-candidate | fixed on develop (`1aa7a4fe`); staging branch at file time |
| [#150](https://github.com/jdmanring/odysseus/issues/150) | HW-Fit lists unservable architectures as runnable — servability gate | upstream-candidate | fixed on develop (`792df19f`); staging branch at file time |
| [#151](https://github.com/jdmanring/odysseus/issues/151) | HW-Fit list: sort refetch lag; quant filter leaks Q4_K_M Ollama rows | upstream-candidate | fixed on develop (`9e4fd14b`); staging branch at file time |

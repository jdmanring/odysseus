...
| [#31](https://github.com/jdmanring/odysseus/issues/31) | World-class structured logging system | upstream-candidate | 3 PRs: `feat/logging-core`, `feat/logging-timing`, `feat/logging-audit` |

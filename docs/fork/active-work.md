...
| [#23 aria2c reliability + download card UI bugs](https://github.com/jdmanring/odysseus/issues/23) | `fix/aria2c-download-reliability` | tmux width fix, totalFiles fallback, conn_per_file 3, tab indent, download-result=full, empty-dir check, HfUrlResolver HTTP fallback + basename filter. Upstream draft staged — file after #12. |

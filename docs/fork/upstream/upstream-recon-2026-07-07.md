...
(`<tool_code>` python-call syntax); different formats, and both coexist on develop.
...
| **#5206** per-endpoint native tool-calling toggle | #60 nvidia-native-tool-calling, #62 api-hosts | Changes how native tool-calling is gated, and may reframe our host-allowlist PRs. |

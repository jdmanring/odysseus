...
| `feat/aria2c-downloader` | [#12](https://github.com/jdmanring/odysseus/issues/12) + [#23](https://github.com/jdmanring/odysseus/issues/23) | Feature | Pause/resume verified (2026-06-12): split-file size correct, pause status stable, resume works. Needs: gated-token live test, screenshot — see pr-drafts/ |

...
| `feat/aria2c-downloader` | [#12](https://github.com/jdmanring/odysseus/issues/12) + [#23](https://github.com/jdmanring/odysseus/issues/23) | Feature | Save point (2026-06-12): pause/resume, split-file size, menu toggle, clear-finished all verified. Pending: tracker-based zombie detection, cancel mid-download, Windows — see pr-drafts/ |

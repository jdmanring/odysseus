...
- A `height: 0; position: sticky; bottom: 8px; overflow: visible` anchor appended as the log's last child — the document's bottom edge never moves when the indicator appears, changes, or leaves.

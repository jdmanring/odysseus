...
const _PROVIDERS = [
  ...
  // LongCat (Meituan) — must precede OpenAI: endpoint path contains /openai/v1
  [/longcat/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M4.86 3.96c-0.33 0.45-4.26 14.46-4.26 15.3 0 0.48 0.3 0.54 2.85 0.54 1.56 0 2.85-0.06 2.85-0.12 0-0.09-0.27-0.63-0.63-1.2-0.93-1.56-0.87-3.96 0.12-5.67 0.42-0.72 0.87-2.01 0.99-2.85 0.09-0.87 0.33-1.56 0.48-1.56 0.18 0 0.84 0.42 1.5 0.96 1.08 0.84 1.41 0.93 3.24 0.93 1.83 0 2.16-0.09 3.24-0.93 0.66-0.54 1.32-0.96 1.5-0.96 0.15 0 0.39 0.63 0.51 1.41 0.09 0.81 0.54 2.1 0.93 2.91 0.99 1.86 1.02 4.26 0.15 5.76-0.36 0.57-0.63 1.11-0.63 1.2 0 0.06 1.29 0.12 2.85 0.12 2.64 0 2.85-0.03 2.85-0.6 0-0.87-3.9-14.76-4.26-15.21-0.54-0.66-1.08-0.45-3.96 1.41-1.53 0.99-2.97 1.8-3.18 1.8-0.21 0-1.65-0.81-3.18-1.8-2.85-1.86-3.42-2.07-3.96-1.44zM9.51 13.41c-0.12 0.09-0.21 0.9-0.21 1.8 0 1.5 0.03 1.59 0.75 1.59 0.72 0 0.75-0.09 0.75-1.8 0-1.56-0.09-1.8-0.54-1.8-0.3 0-0.66 0.09-0.75 0.21zM13.2 14.97c0 1.77 0.03 1.83 0.75 1.83 0.75 0 0.78-0.06 0.69-1.74-0.09-1.5-0.18-1.71-0.75-1.8-0.66-0.09-0.69 0-0.69 1.71z"/></svg>'],
  ...
  [/fireworks/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14.8 6.17L12 12.88L9.2 6.17H7.4L10.47 13.51C10.72 14.12 11.32 14.51 11.99 14.51C12.65 14.51 13.25 14.12 13.51 13.51L16.6 6.17H14.8ZM16 16.4L21.12 11.22L20.42 9.57L14.82 15.24C14.36 15.71 14.22 16.41 14.48 17.02C14.74 17.63 15.33 18.02 16 18.02H24L23.3 16.36ZM2.88 11.21L3.58 9.56L9.17 15.23C9.64 15.7 9.78 16.41 9.52 17.02C9.26 17.63 8.67 18.02 8 18.02H0L0.7 16.36L8 16.39Z"/></svg>'],
  ...
  // xAI — Grok (stylized X). x\.ai matches hostname api.x.ai; xai matches model prefixes.
  [/x-ai|xai|x\.ai|grok/i,

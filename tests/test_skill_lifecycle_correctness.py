...
_TOOL_IMPL_SRC = (
    Path(__file__).resolve().parent.parent / "src/tools/system.py"  # manage_skills moved here from tool_implementations.py
).read_text(encoding="utf-8")
...
def test_tool_implementations_add_has_no_auto_approve_true_fallback():
    """manage_skills add (src/tools/system.py) must not auto-publish via pref.
